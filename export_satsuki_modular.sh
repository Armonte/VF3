...
echo "📁 Input: data/arcueid.TXT"

OUTPUT_FILE="arcueid_modular_$(date +%Y%m%d_%H%M%S).glb"
echo "📦 Output: $OUTPUT_FILE"

# Run the modular exporter
blender --background --python vf3_blender_exporter_modular.py -- data/arcueid.TXT "$OUTPUT_FILE"
